  ...
  return (
    <main className="mobile-shell flex flex-col bg-white">
      <header className="flex items-center gap-3 px-4 pt-[calc(16px+env(safe-area-inset-top))] pb-2">
        ...
        <h1 className="text-[18px] font-bold text-[#1f2024]">{t.loginPageTitle}</h1>
      </header>
      ...
      <div className="px-6 pb-[calc(40px+env(safe-area-inset-bottom))] space-y-3">
        ...
        <p className="text-center text-[13px] text-[#8a8c91] pt-2">
          {t.loginNoAccountLabel}{" "}
          <Link href="/cadastro" className="font-semibold text-[#173EA5]">
            {t.loginSignupLink}
          </Link>
        </p>
      </div>
...
function LoginTrainer() {
  return (
    <svg viewBox="0 0 160 180" fill="none" aria-hidden="true" className="h-full w-full">
      <ellipse cx="80" cy="172" rx="50" ry="8" fill="#173EA5" fillOpacity="0.1" />
      <rect x="55" y="72" width="50" height="65" rx="10" fill="#EF5350" />
      <rect x="55" y="72" width="50" height="18" rx="9" fill="#B71C1C" />
      <circle cx="80" cy="58" r="22" fill="#FFCCBC" />
      <rect x="44" y="82" width="14" height="36" rx="7" fill="#EF5350" />
      <rect x="102" y="82" width="14" height="36" rx="7" fill="#EF5350" />
      <rect x="60" y="135" width="16" height="40" rx="7" fill="#1565C0" />
      <rect x="84" y="135" width="16" height="40" rx="7" fill="#1565C0" />
      <rect x="58" y="172" width="20" height="8" rx="4" fill="#37474F" />
      <rect x="82" y="172" width="20" height="8" rx="4" fill="#37474F" />
      <rect x="68" y="42" width="24" height="13" rx="6" fill="#B71C1C" />
    </svg>
  );
}
